<?php
session_start(); // Bắt đầu session để lưu trữ thông tin lỗi nếu có
?>
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    <?php if (isset($_SESSION['login_error'])): ?>
                        ...
                        <?php unset($_SESSION['login_error']); // Xóa lỗi sau khi hiển thị ?>
                    <?php endif; ?>

                    <!-- Form đăng nhập -->
                    <form action="dashboard.php?action=SignIn" method="POST">
                        ...
                        <div class="input-group mb-3">
                            <button type="submit" name="signIn" value="Login" class="btn btn-lg btn-primary w-100 fs-6">Login</button>
                        </div>
                        <div class="input-group mb-3">
                            <button type="button" class="btn btn-lg btn-light w-100 fs-6">
                                <img src="../../public/images/google.png" style="width:20px" class="me-2">
